...
def init_config():
    if 'deployment_name' not in st.session_state:
        ...
        from config_data import set_environment_details_gpt4, get_deployment_name_gpt4_32k
...
# openai_api_base =  'https://oaisvcsansri.openai.azure.com/'
...
st.title("Employment Offer Generator")

doc_template_name = '1-EmploymentOfferTemplate.txt'
